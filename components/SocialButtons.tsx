...
const SocialButtons = () => {
  const socials = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          ></path> 
              <path d="M87.49 53.127c0-5.2.453-9.836.453-9.836m0 0c.438-21.124-12.821-17.704-22.559-17.087M50.238 37.67c0-2.079 2.415-8.055 15.145-11.466" 
          ></path> 
            </g> 
          </g>
        </svg>),
    ...
    },
    {
      name: 'Pinterest',
      icon: (
  <svg className="w-7 h-7 sm:w-8 sm:h-8" width="256" height="256" viewBox="0 0 256 256">
  <g style={{ stroke: 'none', strokeWidth: 0, strokeDasharray: 'none', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeMiterlimit: 10, fill: 'none', fillRule: 'nonzero', opacity: 1 }} transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
    ...
    strokeLinecap="round"/>
      ...
      url: 'https://pinterest.com/00pinaddict00',
      label: 'Seguici su Pinterest',
    },
  ];
        ...
        <div className="flex justify-center items-center gap-4 sm:gap-6 md:gap-8">
          {socials.map((social) => (
            <a
              ...
              className="max-w-16 max-h-16 bg-[#f06aa7] hover:bg-pink-500 text-white w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg hover:shadow-xl"
            >
              {social.icon}
            </a>
          ))}
